...
public class GPEquivalence4Par implements core.SemanticModule {
     ...
     * @param prog The program to be representaed semantically
     ...
     * @param bddToTranslate The semantic representation to translate
     * @return The code implementation of the semantic representation 
     */
