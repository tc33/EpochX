 ...
 */
public class GPEquivalenceReg implements SemanticModule {
     ...
     * @return Returns TRUE if the programs are semantically equivalent
     */
    ...
    /**
     * Traslates a program to a semantic representation
     * @param prog The program to be translated
    ...
    /**
     * Translates a sematic representation to a program
     * @param bddToTranslate The representation to be translated
     * @return The program
     */
    public ArrayList<String> repToCode(BehaviourRepresentation bddToTranslate) {
        ...
        variableToTerminal.put("3", "D0");
        variableToTerminal.put("4", "D1");
        variableToTerminal.put("5", "D2");
        variableToTerminal.put("6", "D3");
