 ...
 * GE representation. The even-5-parity problem involves evolving a program
 ...
 * <li>{@link HitsCount#INPUT_IDENTIFIERS}: <code>new String[]{"D0", "D1", "D2", "D3", "D4"}</code>
 ...
 * @since 2.0
 */
public class Even5Parity extends GenerationalTemplate {
