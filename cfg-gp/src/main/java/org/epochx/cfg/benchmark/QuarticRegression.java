...
/**
 * This template sets up EpochX to run the quartic regression benchmark with
 * the GE representation. Quartic regression involves evolving an equivalent
 ...
 * @since 2.0
 */
public class QuarticRegression extends GenerationalTemplate {
