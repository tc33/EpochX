 ...
 * @since 2.0
 */
public abstract class CFGFitnessFunction extends AbstractFitnessFunction {

	/**
	 * The key for setting the interpreter to use to execute individuals
	 */
	public static final ConfigKey<Interpreter<CFGIndividual>> INTERPRETER = new ConfigKey<Interpreter<CFGIndividual>>();
