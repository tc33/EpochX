...
/**
 * Initialisation method which produces <code>GRIndividual</code>s with full parse 
 ...
 * @since 2.0
 */
public class FullInitialisation implements GRInitialisation, Listener<ConfigEvent> {
	...
	/**
	 * Creates a population of new <code>GRIndividuals</code> with full parse trees. Each 
	...
	/**
	 * Constructs a new <code>GRIndividual</code> with a full derivation tree
	 * 
	 ...
	 * If automatic configuration is enabled then any value set here will be overwritten by the
	 * {@link GRIndividual#MAXIMUM_DEPTH} configuration setting on the next config event.
	 * 
