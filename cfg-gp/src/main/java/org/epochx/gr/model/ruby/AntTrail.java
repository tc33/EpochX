...
public abstract class AntTrail extends GRModel {
	...
	public AntTrail(Evolver evolver, final Point[] foodLocations, final Dimension landscapeSize, final int allowedTimeSteps) {
		...
		setFitnessEvaluator(new AntEvaluator<GRCandidateProgram>(new RubyInterpreter<GRCandidateProgram>(new GRSourceGenerator()), params, landscape, ant, foodLocationsList, allowedTimeSteps));
	}
}
