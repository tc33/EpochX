 ...
 */
public interface LifeCycleListener extends CrossoverListener, ElitismListener,
		GenerationListener, InitialisationListener, MutationListener,
		PoolSelectionListener, ReproductionListener, TerminationListener {
