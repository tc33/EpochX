...
public class LifeCycleManager {
	 ...
	 * different or modified list of <code>CandidatePrograms</code> or null.
	 */
	...
	public List<CandidateProgram> fireElitismEvent(List<CandidateProgram> elites) {
		for (ElitismListener listener: elitismListeners) {
			...
			if (elites == null) {
				throw new NullPointerException("an elitism listener returned elites as null");
			}
		}
	 ...
	 * <code>CandidatePrograms</code>. <code>null</code> is also a valid return
	 * value.
	 */
	public CandidateProgram[] fireCrossoverEvent(final CandidateProgram[] parents,
	 ...
	 * or potentially an entirely different <code>CandidateProgram</code>. 
	 * <code>null</code> is also a valid return value.
	 */
