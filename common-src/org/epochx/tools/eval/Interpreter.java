...
public interface Interpreter {
	 ...
	 * associated value from the <code>argValues</code> array. The returned array will
	 ...
	 * 
	 * <p>Some <code>Interpreters</code> may choose to simply implement this 
	 * method by calling the single use <code>eval</code> method, but for 
	 * certain other interpreters it may be possible to get large performance 
	 * gains with an interpreter by performing all evaluations in one.
	 * 
	 ...
	 * 
	 * <p>Some <code>Interpreters</code> may choose to simply implement this 
	 * method by calling the single use <code>exec</code> method, but for 
	 * certain other interpreters it may be possible to get large performance 
	 * gains with an interpreter by performing all executions in one.
	 * 
	 * @param program the program source code that is to be executed.
	 * @param argNames an array of arguments that each of the sets of argValues 
	 * 				   should be assigned to. The array should have equal 
