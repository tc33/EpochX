...
public final class BoolUtils {
	 ...
	 * to the size limitations of the int datatype, and maximum array sizes.
	 * There are also likely to be issues with heap space. Alternatively users
	 * should use the BoolUtils.generateBoolSequence(int, long) method which
	 * generates the same boolean arrays on an individual basis.
	 * 
	 ...
	 *         given number of elements. There will be 2^noBits combinations and
	 *         so
	 ...
	 *         BoolUtils.generateBoolSequences, where
	 *         n == index. Each valid index value will return a unique
	 *         combination of
	 *         booleans.
	 */
