...
public final class DataTypeUtils {
	...
	/**
	 * Returns <code>true</code> if the given collection contains an element which
	 ...
	 * @return <code>true</code> if the given collection contains a class which is
	 ...
	 *        assignable to
	 * @param cls the class that is being searched against <code>collection</code>
	 * @return <code>true</code> if the given collection contains a class which is
	 ...
	 * 
	 * @param collection the classes that must all be sub-types of <code>cls</code>
	 * @param cls the type to compare against <code>collection</code>
	 * @return <code>true</code> if all classes in <code>collection</code> are sub-types
	 *         of, or the same type as, <code>cls</code> and returns <code>false</code>
	 *         otherwise
	 */
	...
	/**
	 * Returns <code>true</code> if all classes in the <code>collection</code> array
	 * are equal to <code>cls</code>
	 * 
	 * @param collection the classes to compare against <code>cls</code> for
	 *        equality
	 * @param cls the type to compare against <code>collection</code>
	 * @return <code>true</code> if all classes in <code>collection</code> are the same
	 *         type as <code>cls</code> and <code>false</code> otherwise
	 */
	 ...
	 * class types. Any of <code>Byte</code>, <code>Short</code>, <code>Integer</code> will
	 * resolve to <code>Integer</code>.
	 * 
	 ...
	 *         both types, or <code>null</code> if there is no compatible numeric
	 *         type
	 */
	 ...
	 * (one of <code>Byte, Short, Integer, Long</code>)
	 * 
	 * @param type the type to check
	 * @return <code>true</code> if it is a primitive integer type, <code>false</code>
	 *         otherwise
	 */
	 ...
	 * (one of <code>Byte, Short, Integer, Long, Float, Double</code>)
	 * 
	 * @param type the type to check
	 * @return <code>true</code> if it is a numeric type, <code>false</code> otherwise
	 */
