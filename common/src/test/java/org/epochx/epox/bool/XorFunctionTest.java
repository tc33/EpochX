...
public class XorFunctionTest extends NodeTestCase {
	...
	/**
	 * Tests that {@link org.epochx.epox.bool.XorFunction#dataType(Class...)}
	...
	public void testEpoxParser() {
		...
		try {
			...
			Node n = parser.parse("XOR(X, X)");
			assertSame("Parsing did not return an instance of the correct node", XorFunction.class, n.getClass());
