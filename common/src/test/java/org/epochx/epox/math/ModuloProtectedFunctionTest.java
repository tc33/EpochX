...
public class ModuloProtectedFunctionTest extends NodeTestCase {
	...
	/**
	 * Tests that {@link org.epochx.epox.math.ModuloProtectedFunction#dataType(Class...)}
	...
	public void testGetReturnTypePMod() {
		...
		for (Class<?> type: inputTypes) {
			returnType = pmod.dataType(type, type);
			assertSame("unexpected return type", type, returnType);
		}
		
		returnType = pmod.dataType(Short.class, Double.class);
		assertSame("unexpected return type", Double.class, returnType);
		
		returnType = pmod.dataType(Long.class, Integer.class);
		assertSame("unexpected return type", Long.class, returnType);
		
		returnType = pmod.dataType(Byte.class, Float.class);
		assertSame("unexpected return type", Float.class, returnType);
		
		returnType = pmod.dataType(Boolean.class, Integer.class);
		assertNull("non-numeric type for child should be invalid", returnType);
		
		returnType = pmod.dataType(Integer.class, Integer.class, Integer.class);
	...
	public void testEpoxParser() {
		...
		try {
			...
			Node n = parser.parse("MOD(X, X)");
			assertSame("Parsing did not return an instance of the correct node", ModuloProtectedFunction.class, n.getClass());
