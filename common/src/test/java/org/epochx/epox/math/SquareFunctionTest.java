...
public class SquareFunctionTest extends NodeTestCase {
	...
	/**
	 * Tests that {@link org.epochx.epox.math.SquareFunction#dataType(Class...)}
	...
	public void testGetReturnTypeCube() {
		...
		for (Class<?> type: inputTypes) {
			returnType = sq.dataType(type);
			assertSame("unexpected return type", type, returnType);
		}
		
		returnType = sq.dataType(Boolean.class);
		assertNull("non-numeric type for child should be invalid", returnType);
		
		returnType = sq.dataType(Integer.class, Integer.class);
	...
	public void testEpoxParser() {
		...
		try {
			...
			Node n = parser.parse("SQUARE(X)");
			assertSame("Parsing did not return an instance of the correct node", SquareFunction.class, n.getClass());
