...
public interface TerminationCriteria {
	...
	/**
	 * Indicates whether the given evolutionary run should terminate due to 
	 * some stopping condition having been met. The exact point at which this 
	 * method is called is determined by the specific evolutionary strategy in
	 * use.
	 * 
