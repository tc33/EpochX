...
public abstract class Regression extends GEModel {
	...
	public Regression(Evolver evolver, final int noPoints) {
		...
		setFitnessEvaluator(new HitsCountEvaluator<GECandidateProgram>(new JavaInterpreter<GECandidateProgram>(new DepthFirstMapper(evolver)), params, outputs, POINT_ERROR));
	}
