...
public interface GECrossover extends Crossover {
	 ...
	 * 
	 * @param parent1 The first GEIndividual selected to undergo this
	 *        crossover operation.
	 * @param parent2 The second GEIndividual selected to undergo this
	 *        crossover operation.
	 ...
	 */
	@Override
	public GEIndividual[] crossover(CandidateProgram parent1, CandidateProgram parent2);
