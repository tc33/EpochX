...
public interface GEMutation extends Mutation {
	 ...
	 * material of the given GEIndividual, returning the resultant
	 * program.
	 * 
	 * @param program The GEIndividual selected to undergo this mutation
	 *        operation.
	 * @return A GEIndividual that was the result of altering the provided
	 *         GEIndividual.
	 */
	@Override
	public GEIndividual mutate(CandidateProgram program);
