...
public class PointMutation implements GEMutation, ConfigListener {
	...
	/**
	 * Perform point mutation on the given GEIndividual. Each codon in the
	 ...
	 * replace it.
	 * 
	 * @param p The GEIndividual selected to undergo this mutation
	 *        operation.
	 * @return A GEIndividual that was the result of a point mutation on
	 *         the provided GEIndividual.
	 */
	@Override
	public GEIndividual mutate(final CandidateProgram p) {
		final GEIndividual program = (GEIndividual) p;
