...
public class SinglePointMutation implements GEMutation, ConfigListener {
	...
	/**
	 * Perform point mutation on the given GEIndividual. A codon position
	 ...
	 *        operation.
	 * @return A GEIndividual that was the result of a single point
	 *         mutation
	 *         on the provided GEIndividual.
	 */
	@Override
