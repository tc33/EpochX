...
/**
 * A stat that returns the minimum length of all the chromosomes in the 
...
public class GenerationMinimumLength extends AbstractStat<EndGeneration> {
	...
	/**
	 * Returns the minimum length of the chromosomes in the previous generation
	 * 
	 * @return the minimum length of the chromosomes
	 */
