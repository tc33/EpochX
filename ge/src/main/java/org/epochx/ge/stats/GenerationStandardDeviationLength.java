 ...
 * individuals in the population must be instances of <code>GEIndividual</code>.
 * 
...
public class GenerationStandardDeviationLength extends AbstractStat<EndGeneration> {
	...
	/**
	 * Constructs a <code>GenerationStandardDeviationLength</code> stat and registers
	 * its dependencies
	 */
	...
	/**
	 * Returns the standard deviation of the mean length of the chromosomes in
	 * the previous generation
	 * 
	 * @return the standard deviation of the mean length of the chromosomes
	 */
