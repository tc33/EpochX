 ...
 * error option is used, otherwise the objects are just compared for equality.
 * 
 ...
 * @since 2.0
 */
public class HitsCount extends STGPFitnessFunction implements Listener<ConfigEvent> {
