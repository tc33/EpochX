...
/**
 * The SyntaxAA class conatins the basic syntax for the boolean programs 
 * @author Lawrence Beadle
 */
public class SyntaxAA implements CoreN.Syntax {
    ...
    /**
     * The SyntaxAA constructor defines the basic syntax for the 4 Parity Problem. 
     * This is the section to be edited to change the syntax of a problem
     */
    public SyntaxAA() {
        ...
        eStart.add("MOVE");
        eStart.add("TURN-LEFT");
        eStart.add("TURN-RIGHT");
        eStart.add("(");
        
        // make a list of fucntions --------------------------------------------
        funcs.add("IF-FOOD-AHEAD");
        funcs.add("PROGN2");
        funcs.add("PROGN3");
