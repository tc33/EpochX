 ...
 */
public class GPEquivalence7Par implements CoreN.SemanticModule {
    
    private BDDFactory b;
    private BDD dZero, dOne, dTwo, dThree, dFour, dFive, dSix;    
    private int depth;
     ...
     * @return TRUE if programs are semantically equivalent
     */
    ...
    /**
     * Creates a semantic representation from a program
    ...
    /**
     * Translates a semantic representation back to code
     * @param bddToTranslate The representation to translate
     * @return The program implementation of the semantic representation
     */
