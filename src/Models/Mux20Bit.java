...
import modelsupport.mux20bitcode.*;
import core.*;
 ...
 */
public class Mux20Bit extends GPCoreCode {
    ...
    public Mux20Bit() {
        ...
        super.scorer = new Scorer20bit();
        
        // instantiate syntax objects
        Syntax20bit syn = new Syntax20bit();
        ...
        super.semanticMod = new GPEquivalence20bit();
