...
public class GPEquivalence11bit implements Core.SemanticModule {
    ...
    public ArrayList<String> repToCode(BehaviourRepresentation bddToTranslate) {
        ...
        variableToTerminal.put("4", "D0");
        variableToTerminal.put("5", "D1");
        variableToTerminal.put("6", "D2");
        variableToTerminal.put("7", "D3");
        variableToTerminal.put("8", "D4");
        variableToTerminal.put("9", "D5");
        variableToTerminal.put("10", "D6");
        variableToTerminal.put("11", "D7");
