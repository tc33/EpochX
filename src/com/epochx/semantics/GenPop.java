...
public class GenPop {
    ...
    /**
     * Parses brackets to test cyntax
     * @param toTest syntax to test
    ...
    /**
     * Reduces the artifical ant behaviour
     * @param result Ant representation to reduce
     * @return The reduced ant representation
     */
