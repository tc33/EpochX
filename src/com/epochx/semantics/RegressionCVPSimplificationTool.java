...
public class RegressionCVPSimplificationTool {
	...
	/**
	 * Simplifies all the polynomials with respect to variable and power
	 */
	...
	/**
	 * returns an array of the powers and coefficients
	 * @return an array of the powers and coefficients
	 */
	public double[][] getListOfPowersAndCoefficients() {
		// TODO
