...
public abstract class AbstractModelTestCase extends TestCase {
	...
	/**
	 * Tests that trying to set a negative number of generations throws an exception.
	 */
	...
	/**
	 * Tests that trying to set population size lower than one throws an exception.
	 */
	...
	/**
	 * Tests that trying to set number of elites lower than zero throws an exception.
	 */
	...
	/**
	 * Tests that trying to set a crossover probability lower than zero throws an exception.
	 */
	...
	/**
	 * Tests that trying to set a crossover probability greater than 1.0 throws an exception.
	 */
	...
	/**
	 * Tests that trying to set a mutation probability lower than zero throws an exception.
	 */
	...
	/**
	 * Tests that trying to set a mutation probability greater than 1.0 throws an exception.
	 */
	...
	/**
	 * Tests that the default reproduction probability property is set correctly. 
	 */
	...
	/**
	 * Tests that trying to set a reproduction probability lower than zero throws an exception.
	 */
	...
	/**
	 * Tests that trying to set a reproduction probability greater than 1.0 throws an exception.
	 */
	...
	public void testProgramSelectorDefault() {
		...
		ProgramSelector programSelector = model.getProgramSelector();
		...
		int tournamentSize = ((TournamentSelector) programSelector).getTournamentSize();
	...
	/**
	 * Tests that trying to set a null random number generator throws an exception.
	 */
