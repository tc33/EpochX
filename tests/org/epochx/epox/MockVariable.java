...
/**
 * A mock variable for the purpose of testing.
 */
public class MockVariable extends Variable {
	...
	/**
	 * Constructs a <code>MockVariable</code> with an identifier of 'mock', a 
	 * data-type of Void, and a value of <code>null</code>.
	 */
	public MockVariable() {
		super("mock", Void.class);
	}
	...
	/**
	 * Returns the mock return type of this variable.
	 * 
	...
	/**
	 * Returns the mock value of this variable.
	 * 
	 * @return the mock value of this variable.
	 */
	@Override
