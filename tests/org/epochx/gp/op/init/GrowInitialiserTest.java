...
public class GrowInitialiserTest {
	...
	// System.out.println(Stats.get().getStat(SubtreeCrossover.XO_POINT1) + " "
	// + Stats.get().getStat(SubtreeCrossover.XO_SUBTREE1));
	// System.out.println(Stats.get().getStat(SubtreeCrossover.XO_POINT2) + " "
	// + Stats.get().getStat(SubtreeCrossover.XO_SUBTREE2));
	// }
	// System.out.println("-------------------------------------------");
	// }
	// }
