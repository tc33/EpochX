...
public class Multiplexer extends GEModel {
	...
	public Multiplexer(Evolver evolver, final int noInputBits) {
		...
		setFitnessEvaluator(new HitsCountEvaluator<GECandidateProgram>(new RubyInterpreter<GECandidateProgram>(new DepthFirstMapper(evolver)), params, expectedResults));
	}
