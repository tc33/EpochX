...
public class GPStatsEngine extends StatsEngine {
	...
	private Object getGenDepths() {
		...
		final List<GPCandidateProgram> pop = (List<GPCandidateProgram>) model.getStatsManager().getGenerationStat(GEN_POPULATION);
	...
	private Object getGenAveNodesPerDepth() {
		...
		final int[] depths = (int[]) model.getStatsManager().getGenerationStat(GEN_DEPTHS);
		final int maxDepth = (Integer) model.getStatsManager().getGenerationStat(GEN_DEPTH_MAX);
		final List<GPCandidateProgram> pop = (List<GPCandidateProgram>) model.getStatsManager().getGenerationStat(GEN_POPULATION);
	...
	private Object getGenLengthMin() {
		...
		final int[] lengths = (int[]) model.getStatsManager().getGenerationStat(GEN_LENGTHS);
	...
	private Object getGenNoTerminalsMin() {
		...
		final int[] noTerminals = (int[]) model.getStatsManager().getGenerationStat(GEN_NO_TERMINALS);
	...
	private Object getGenNoDistinctTerminalsMin() {
		...
		// Request the population's number of distinct terminals from the stats manager.
		final int[] noTerminals = (int[]) model.getStatsManager().getGenerationStat(GEN_NO_DISTINCT_TERMINALS);
	...
	private Object getGenNoFunctionsMin() {
		...
		final int[] noFunctions = (int[]) model.getStatsManager().getGenerationStat(GEN_NO_FUNCTIONS);
	...
	private Object getGenNoDistinctFunctionsMin() {
		...
		// Request the population's number of distinct functions from the stats manager.
		final int[] noFunctions = (int[]) model.getStatsManager().getGenerationStat(GEN_NO_DISTINCT_FUNCTIONS);
