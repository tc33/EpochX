...
/**
 * Grammar model that describes a cubic symbolic regression problem to be solved
 * with the evolution of an Epox program.
 * 
 * <p>
...
public class CubicRegression extends GRModel {
	 ...
	 */
    private double function(final double x){
        return x + x*x + x*x*x;
    }
}
